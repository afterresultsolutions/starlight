...
size:0.9em;display:none;">Minimum budget is ₹5,000</span>
  </div>
...
Only request via WhatsApp or call.";
      ...
      else if (dmObjective === "Traffic" || dmObjective === "Engagement") dmFee = 
3500;
...
""}<br>Duration: ${svc.duration || 1} month(s)`;
        if (svc.budget > 20000) {
          ...
          else if (svc.objective === "Traffic" || svc.objective === "Engagement") fee = 
3500;
